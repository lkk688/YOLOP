...
_C.DATASET.DATAROOT = '/DATA5T2/Datasets/BDD/bdd100k/images/100k'       # the path of images folder
_C.DATASET.LABELROOT = '/DATA5T2/Datasets/BDD/YOLOP/100kdetannotation'#'/home/zwt/bdd/bdd100k/labels/100k'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/DATA5T2/Datasets/BDD/YOLOP/bdd_seg_gt'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/DATA5T2/Datasets/BDD/YOLOP/bdd_lane_gt'               # the path of ll_seg_annotations folder
...
_C.TRAIN.VAL_FREQ = 1
_C.TRAIN.BATCH_SIZE_PER_GPU =8 #24
